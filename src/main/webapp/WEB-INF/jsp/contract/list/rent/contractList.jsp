...
<script type="text/html" id="contractTypeTpl">
    <span class="label label-success radius" data-d="{{d.contractType}}" onmouseover="show_shopm(this)" onmouseout="exit_shopm()">{{ d.contractType }}</span>
</script>
<!--合同状态-->
            ...
            table.on('toolbar(LAY_table_user)', function (obj) {
                ...
                switch (obj.event) {
                    case 'create':
                        var _funbtnxs = {
                            yesxs1: function (index, layero) {
                                ...
                                if (!reg.test(contractNumber)) {
                                    layer.msg('合同编号只能由字母和数字组成,且以字母开头,6<=长度<=20',
                        ...
                        tk('<span style="font-weight: bold">【租赁合同】</span>添加合同', ['100%', '100%'], 'userbj', $("#bjnr"), ['确定', '关闭'], _funbtnxs);
                        // 下拉框值改变动态设置其它输入
                    ...
                    case 'update':
                        ...
                        tk('<span style="font-weight: bold">【租赁合同】</span>修改合同', ['100%', '100%'], 'userbj', $("#bjnr"), ['确定', '关闭'], _funbtnxs);
                        // 下拉框值改变动态设置其它输入
                        form.on('select(marketPerson)', function (data) {
                            if(data.value == "其它__") {
                                $("#marketPersonInput").val('');
                    ...
                    case 'detail':
                        ...
                        tk('<span style="font-weight: bold">【租赁合同】</span>添加合同明细', ['100%', '100%'], 'userbj', $("#bjnr2"), ['确定', '关闭'], _funbtnxs);
                        // 下拉框值改变动态设置其它输入
    ...
    <form class="layui-form" id="form-validate">
        <table class="layui-table layui-xs" lay-skin="nob">
            ...
            <tr>
                ...
                <td align="left">
                    <input type="text" id="contractNumber" name="contractNumber" autocomplete="off"
            ...
            <tr>
                ...
                <td align="left">
                    <select class="layui-input" id="contractType" disabled><!--限制修改-->
                        <option value="租赁" selected>租赁</option>
