...
<body>
	...
	<div class="page-container">
		<div class="layui-form" style="height: 31px;">
		    <label><b>车识别码:</b></label> 
			<div class="layui-inline" style="width: 200px;">
				<input type="text" id="vehicleNumber" name="vehicleNumber" autocomplete="off" class="layui-input" placeholder="请输入车识别码">
			</div>
	...
	<script type="text/javascript">
		...
		function GetData() {
			...
			$.ajax({
				type : 'POST',
				url : "${pageContext.request.contextPath}/getSearchByVehicle",
